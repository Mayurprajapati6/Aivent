  ...
  return (
    <footer className="border-t border-gray-800/50 py-8 px-6 max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4">
      <div className="flex items-center gap-6 text-sm text-gray-400">
        Made with ❤️ by Aivent
      </div>
      <div className="flex gap-4 items-center">
        <a href="https://www.youtube.com/roadsidecoder" className="text-gray-400">
          <Youtube />
        </a>
        <a href="https://www.instagram.com/roadsidecoder" className="text-gray-400">
